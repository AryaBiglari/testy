        ...
        <FormGroup>
          ...
          >
            ...
            <FormControlLabel
              ...
              label={<Typography>Frames</Typography>}
              sx={{
                "& .MuiSvgIcon-root": {
                  fontSize: "1.25rem",
            ...
            <FormControlLabel
              ...
              label={<Typography>Walls</Typography>}
              sx={{
                "& .MuiSvgIcon-root": {
                  fontSize: "1.25rem",
                  color: "var(--success75)",
            ...
            <FormControlLabel
              ...
              label={<Typography>Boxes</Typography>}
              sx={{
                "& .MuiSvgIcon-root": {
                  fontSize: "1.25rem",
                  color: "var(--primary75)",
            ...
            <FormControlLabel
              ...
              label={<Typography>Cutting + Bending</Typography>}
              sx={{
                "& .MuiSvgIcon-root": {
                  fontSize: "1.25rem",
            ...
            <FormControlLabel
              ...
              label={<Typography>Small Parts</Typography>}
              sx={{
                "& .MuiSvgIcon-root": {
                  fontSize: "1.25rem",
            ...
            <FormControlLabel
              ...
              label={<Typography>Finishing</Typography>}
              sx={{
                "& .MuiSvgIcon-root": {
                  fontSize: "1.25rem",
