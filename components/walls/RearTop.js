...
export default function RearTop(props) {
  ...
  const handleClickOpenEmployeesWorking = () => setOpenEmployeesWorking(true);
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Typography sx={{ fontSize: "1.1rem" }}>Rear Top</Typography>
              <IconButton
              ...
              {trailer?.walls?.filter((wall) => wall.wallType === "Rear Top")[0]
                ?.specialRequirements && (
            ...
            >
              ...
              {isCompleted && (
                <Typography sx={{ minWidth: "15rem", color: "var(--success)" }}>
