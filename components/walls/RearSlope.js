...
export default function RearSlope(props) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Typography sx={{ fontSize: "1.1rem" }}>Rear Slope</Typography>
          <IconButton
          ...
          {trailer?.walls?.filter((wall) => wall.wallType === "Rear Slope")[0]
            ?.specialRequirements && (
