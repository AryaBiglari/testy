...
export default function AddPartDialog(props) {
  ...
  const [liftAxle, setLiftAxle] = React.useState("");
        ...
        <DialogContent dividers>
          ...
          >
            ...
            <Box sx={{ width: "14rem", zIndex: 1, ml: 2, mr: 1 }}>
              <FormControl fullWidth size="small">
                <InputLabel id="doors-type-label">Door Opening Direction</InputLabel>
                <Select
                ...
                >
                  ...
                  <MenuItem value={"Forward"}>Forward (Only 3 Hoppers Middle Hopper)</MenuItem>
                  <MenuItem value={"Backwards"}>Backwards (Only 3 Hoppers Middle Hopper)</MenuItem>
                </Select>
              </FormControl>
            </Box>
            ...
            <Box sx={{ width: "11rem", zIndex: 1, ml: 1 }}>
              <FormControl fullWidth size="small">
                <InputLabel id="hopper-door-size-label">Hopper Door Size</InputLabel>
                <Select
            ...
            <Box sx={{ width: "10rem", mr: 1 }}>
              <FormControl fullWidth size="small">
                ...
                >
                  ...
                  <MenuItem value={"No Air Inflation"}>No Air Inflation</MenuItem>
