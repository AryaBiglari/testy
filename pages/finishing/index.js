...
import RenderPartsLists from "../../components/finishing/RenderPartsLists.js";
import FinishingRow from "../../components/finishing/FinishingRow.js";
...
export default function Frames() {
  ...
  const handleClickOpenDrawings = (trailer, type) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {eng ? "Frame and Box Finishing" : "Acabados de marco y caja"}
          </Typography>
        </Box>
        <Box
          sx={{
